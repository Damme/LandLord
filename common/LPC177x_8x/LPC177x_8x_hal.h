...
#define WTD_ENABLE           (GPIO_TYPE(PORT_3, PIN_12, FUNC_0)) // pull down to enable
#define WTD_TRIGGER          (GPIO_TYPE(PORT_3, PIN_11, FUNC_0)) // 1us pulse every ?
...
#define MOTOR_LEFT_FORWARD   (GPIO_TYPE(PORT_4, PIN_25, FUNC_0))
...
#define MOTOR_RIGHT_FORWARD  (GPIO_TYPE(PORT_5, PIN_4,  FUNC_0))
...
#define MOTOR_BLADE_FORWARD  (GPIO_TYPE(PORT_1, PIN_6,  FUNC_0))
