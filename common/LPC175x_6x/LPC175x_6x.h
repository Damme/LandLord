 ...
 *                                                            modified by Keil
******************************************************************************/
// Modification by Daniel Wiegert
// Removed prefix "FIO" on all FIODIR FIOPIN FIOSET FIOMASK FIOCLR
//
...
#include "system_LPC175x_6x.h"                 /* System Header                                      */
...
/*------------- Analog-to-Digital Converter (ADC) ---------------------------- CHANGED to be simmilar to 177x*/
